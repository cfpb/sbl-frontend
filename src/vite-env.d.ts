...
interface ImportMetaEnv {
  ...
  readonly SBL_PLAYWRIGHT_TEST_REGTECH_TARGET: string;
  readonly SBL_PLAYWRIGHT_TEST_FILING_TARGET: string;
  readonly SBL_PLAYWRIGHT_TEST_CLEANUP_TARGET: string;
  readonly SBL_PLAYWRIGHT_TEST_MAIL_TARGET: string;
