  ...
  return (
    <div className='mb-[45px] max-w-[670px]'>
      ...
      <p className='lead-paragraph'>
        In order to complete your user profile and access the filing platform
        your financial institution must have a Legal Entity Identifier (LEI).
        Visit the Global LEI Foundation (GLEIF) website for information on how
        to obtain an LEI for your institution.
      </p>
      <p className='mb-[30px]'>
