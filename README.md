...
1. Have the four repos [sbl-frontend](https://github.com/cfpb/sbl-frontend), [sbl-project](https://github.com/cfpb/sbl-project), [regtech-user-fi-management](https://github.com/cfpb/regtech-user-fi-management), [sbl-filing-api](https://github.com/cfpb/sbl-filing-api/) and [regtech-mail-api](https://github.com/cfpb/regtech-mail-api) as **sibling directories**.
   ```
   code-root
   ...
   ```
1. Make sure to `git pull` in each of the directories to have the latest commits.
